  ...
  return <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 text-center md:text-left">
          {isEditing ? <input type="text" value={user.name} onChange={handleNameChange} className="text-3xl font-bold text-[#343a40] mb-2 w-full border-b-2 border-[#28a745] focus:outline-none" /> : <h1 className="text-3xl font-bold text-[#343a40] mb-2">{user.name}</h1>}
